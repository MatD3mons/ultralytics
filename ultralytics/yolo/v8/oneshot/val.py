...
class DetectionValidator(BaseValidator):
    ...
    def build_dataset(self, img_path, sup_path, mode='val', batch=None):
        """Build YOLO Dataset
        ...
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, stride=gs, sup_path=sup_path)

    def get_dataloader(self, dataset_path, sup_path, batch_size):
        ...
        dataset = self.build_dataset(dataset_path, sup_path, batch=batch_size, mode='val')
