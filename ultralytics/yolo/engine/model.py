...
class YOLO:
    ...
    @smart_inference_mode()
    def predict(self, source=None, support=None, stream=False, **kwargs):
        """
        ...
        #TODO add support after source
        return self.predictor.predict_cli(source=source, support=support) if is_cli else self.predictor(source=source, support=support, stream=stream)
