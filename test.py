...
image = Image.open("cannette/valid/images/image_train_png.rf.51ca2b0b7e4e18f5b10abdd374d91379.jpg")
image = np.asarray(image)
results = model.predict(source=image, support=image, task='oneshot')  # predict on an image
